        ...
        <div class="row icon-box" data-aos="zoom-in">
            ...
            <div class="col-lg-12 col-md-12 col-12 ">
                ...
                <div class="row mt-4">
                    ...
                    <form method="POST" action="/update-categoria/{{ $categoria->id }}">
                        @csrf
                        <h2 class="text-center pb-4">@lang('home.edit_category')</h2>
